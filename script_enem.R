...
enem_2010 <- fread("C:/DS/DataViz2/enem_2010.csv", encoding = "UTF-8")
enem_2011 <- fread("C:/DS/DataViz2/enem_2011.csv", encoding = "UTF-8")
enem_2012 <- fread("C:/DS/DataViz2/enem_2012.csv", encoding = "UTF-8")
enem_2013 <- fread("C:/DS/DataViz2/enem_2013.csv", encoding = "UTF-8")
enem_2014 <- fread("C:/DS/DataViz2/enem_2014.csv", encoding = "UTF-8")
enem_2015 <- fread("C:/DS/DataViz2/enem_2015.csv", encoding = "UTF-8")
enem_2016 <- fread("C:/DS/DataViz2/enem_2016.csv", encoding = "UTF-8")
enem_2017 <- fread("C:/DS/DataViz2/enem_2017.csv", encoding = "UTF-8")
